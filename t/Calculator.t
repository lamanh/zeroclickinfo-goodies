...
ddg_goodie_test(
    ...
    '1E2 + 1'         => build_test('101', '1 × 10 ^ 2 + 1'),
    '1 + 1E2'         => build_test('101', '1 + 1 × 10 ^ 2'),
    '2 * 3 + 1E2'     => build_test('106', '2 × 3 + 1 × 10 ^ 2'),
    '1E2 + 2 * 3'     => build_test('106', '1 × 10 ^ 2 + 2 × 3'),
    '1E2 / 2'         => build_test('50', '1 × 10 ^ 2 / 2'),
    '2 / 1E2'         => build_test('1/50 = 0.02', '2 / 1 × 10 ^ 2'),
    '4E5 +1 '         => build_test('400,001', '4 × 10 ^ 5 + 1'),
    '4e5 +1 '         => build_test('400,001', '4 × 10 ^ 5 + 1'),
    '3e-2* 9 '        => build_test('27/100 = 0.27', '3 × 10 ^ -2 × 9'),
    '7e-4 *8'         => build_test('0.0056', '7 × 10 ^ -4 × 8'),
    '6 * 2e-11'       => build_test('1.2 × 10 ^ -10', '6 × 2 × 10 ^ -11'),
    '7 + 7e-7'        => build_test('7.0000007', '7 + 7 × 10 ^ -7'),
    ...
    '83.166.167.160/33'               => build_test('≈ 2.520.186.883,636', '83.166.167.160 / 33'),
    '123.123.123.123/255.255.255.256' => build_test('≈ 0,4823529411746', '123.123.123.123 / 255.255.255.256'),
    'pi/1e9'                          => build_test('≈ 3.14159265359 × 10 ^ -9', 'π / 1 × 10 ^ 9'),
    'pi*1e9'                          => build_test('≈ 3,141,592,653.59', 'π × 1 × 10 ^ 9'),
